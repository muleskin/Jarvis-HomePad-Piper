...
def run_home_screen(screen):
    ...
    #print("Here")
    run_voice_assistant(circles, screen, background,draw_event,idle_event);
...
if __name__ == '__main__':
    ...
    pygame.display.flip()
    pygame.time.delay(1)
    apply_blur_ring_and_text(screen, "Ready, Sir!", blue_ring_thickness=100)
    done = assist.TTS("Ready,Sir!")
    screen.blit(background, (0, 0))
    pygame.display.update()
